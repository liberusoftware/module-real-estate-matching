...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-real-estate-matching?sort=semver)](https://github.com/liberusoftware/module-real-estate-matching/releases/latest) [![Tests](https://github.com/liberusoftware/module-real-estate-matching/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-real-estate-matching/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-real-estate-matching
```
...
<a href="https://github.com/liberusoftware/module-real-estate-matching/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-real-estate-matching" alt="Contributors to liberusoftware/module-real-estate-matching">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-real-estate-matching/graphs/contributors).
