...
final class UpdateMatchProfile
{
    public function handle(MatchProfile $profile, int|string $teamId, array $attributes): MatchProfile
    {
        abort_unless((string) $profile->team_id === (string) $teamId, 404);
